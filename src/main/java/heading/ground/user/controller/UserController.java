...
//TODO 로그인, 회원가입 URL 시큐리티 처리 후 나머지는 RequestMapping으로 Profile
    ...
    public String profile(Model model,
        ...
        if (principal.getRole().equals("SELLER")) {
            ...
            if (books != null) {
                List<UserBookDto> bookDtos = books.stream()
                        .map(b -> UserBookDto.builder()
                                .id(b.getId())
                                .seller(SellerDto
                                        .builder()
            ...
            List<UserBookDto> bookDtos = book.stream()
                    .map(b -> UserBookDto.builder()
                            .seller(SellerDto
                                    .builder()
                                    .id(b.getSeller().getId())
